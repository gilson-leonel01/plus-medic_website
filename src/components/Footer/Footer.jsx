    ...
    <motion.footer initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
      <div className="container py-20 flex flex-col md:flex-row md:items-center justify-between gap-10">
        ...
        <div className="space-y-4">
          ...
          Plus Medic is a dedicated medical institute committed to advancing healthcare solutions and raising awareness about critical health issues. Specializing in COVID-19 statements and a range of illnesses, we prioritize your health with reliable information, expert recommendations, and compassionate care.
          </p>
        </div>
        {/* social icons */}
